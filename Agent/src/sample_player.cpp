...
سلام
خدایا کمکمون کن به حقمون برسیم
یا سی جی ام :دی
 */
...
SamplePlayer::actionImpl()
{
    ...
    //
    dlog.addText( Logger::TEAM,
                  __FILE__": ---chain update start---" );
    ActionChainHolder::instance().update( world() );
    dlog.addText( Logger::TEAM,
                  __FILE__": ---chain update done---" );
...
SamplePlayer::doHeardPassReceive()
{
         ...
         )
    {
        ...
        Body_Intercept2009(false).execute( this );
...
SamplePlayer::createActionGenerator() const
{
    ...
    bool shoot=true,pass=true,cross=true,drible=true,self=true,direct=true;
