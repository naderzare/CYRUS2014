...
public:
    ...
    static const std::string BEFORE_KICK_OFF_CONF2;
    static const std::string NORMAL_FORMATION_CONF2;
    static const std::string DEFENSE_FORMATION_CONF2;
    static const std::string OFFENSE_FORMATION_CONF2;
    static const std::string GOAL_KICK_OPP_FORMATION_CONF2;
    static const std::string GOAL_KICK_OUR_FORMATION_CONF2;
    static const std::string GOALIE_CATCH_OPP_FORMATION_CONF2;
    static const std::string GOALIE_CATCH_OUR_FORMATION_CONF2;
    static const std::string KICKIN_OUR_FORMATION_CONF2;
    static const std::string SETPLAY_OPP_FORMATION_CONF2;
    static const std::string SETPLAY_OUR_FORMATION_CONF2;
    static const std::string INDIRECT_FREEKICK_OPP_FORMATION_CONF2;
    static const std::string INDIRECT_FREEKICK_OUR_FORMATION_CONF2;
...
private:
    ...
    rcsc::Formation::Ptr M_before_kick_off_formation2;

    rcsc::Formation::Ptr M_normal_formation2;
    rcsc::Formation::Ptr M_defense_formation2;
    rcsc::Formation::Ptr M_offense_formation2;

    rcsc::Formation::Ptr M_goal_kick_opp_formation2;
    rcsc::Formation::Ptr M_goal_kick_our_formation2;
    rcsc::Formation::Ptr M_goalie_catch_opp_formation2;
    rcsc::Formation::Ptr M_goalie_catch_our_formation2;
    rcsc::Formation::Ptr M_kickin_our_formation2;
    rcsc::Formation::Ptr M_setplay_opp_formation2;
    rcsc::Formation::Ptr M_setplay_our_formation2;
    rcsc::Formation::Ptr M_indirect_freekick_opp_formation2;
    rcsc::Formation::Ptr M_indirect_freekick_our_formation2;
