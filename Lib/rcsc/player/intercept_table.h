...
public:
    ...
    */
    int secondTeammateReachCycle() const
      {
          return M_second_teammate_reach_cycle;
      }
    ...
    */
    int secondOpponentReachCycle() const
      {
          return M_second_opponent_reach_cycle;
      }
    ...
    */
    const
    PlayerObject * secondTeammate() const
      {
          return M_second_teammate;
      }
    ...
    */
    const
    PlayerObject * secondOpponent() const
      {
          return M_second_opponent;
      }
