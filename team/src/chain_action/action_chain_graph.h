...
class ActionChainGraph {
	public :
		...
		static int tmmate;
public:
	double evaluator(rcsc::Vector2D target);
...
public:
	static std::vector< ActionStatePair > My_result;/////cyrus
	static double My_best_evaluation;/////cyrus
...
private:
    ...
    double passOrDribleEffect(double *cases,
