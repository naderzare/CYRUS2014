...
DIR="/media/fedora/holand/cyrus/src"
...
player_conf="/media/fedora/holand/cyrus/src/player.conf"
config_dir="/media/fedora/holand/cyrus/src/formations-dt"

coach_conf="/media/fedora/holand/cyrus/src/coach.conf"
...
#cp coachLog coachLog.`date +"%Y%m%d%H%M%S"`
